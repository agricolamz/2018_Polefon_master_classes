...
Используя команды из вкладки `Tier` можно поменять структуру разметки на ту, которая хороша для документации языка. Я считаю, что необходимы следующие слои:
